                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="py-4 px-6">
                            <form action="/admin/editar.php" method="POST" class="inline">
                                ...
                                <button type="submit" onclick="cambiarModificar(event, <?= $fila['id_usuario'] ?>)" class="font-medium text-blue-600 dark:text-blue-500 hover:underline" data-modal-toggle="editar">Editar</button>
                            </form>
                        </td>
                        <td class="py-4 px-6">
                            <form action="/admin/borrar.php" method="POST" class="inline">
                                <input type="hidden" name="id" value="<?= $fila['id_usuario'] ?>">
                                <button type="submit" onclick="cambiar(event, <?= $fila['id_usuario'] ?>)" class="font-medium text-red-600 dark:text-red-500 hover:underline" data-modal-toggle="borrar">Borrar</button>
                            </form>
                        </td>
                    </tr>
                <?php endforeach; ?>
